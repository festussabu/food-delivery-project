...
from .views import user_registraion, user_page, login_page_user, order_page, order_page_remove_item, feedback_by_user, payment, display_pnr
...
urlpatterns = [
    ...
    path('display_pnr/', display_pnr, name='display_pnr'),
